{ pkgs, pkgs2, spkgs, inputs, ... }: {
 ...
 services = {
    ...
    ollama = {
      ...
      # 🔥 УДАЛЕНО: rocmOverrideGfx — не нужен для NVIDIA
 ...
 # 🔥 ИСПРАВЛЕНО: заменил rocm-утилиты на nvidia-аналоги
 ...
 # 🔥 ДОБАВЛЕНО: CLI для управления Ollama
 ollama
